package com.ruijing.zl.views.bottombar;
...
public class BottomBarTab extends FrameLayout {
    ...
    private int iconUnSelecter;
    private int iconSelector;

    public BottomBarTab(Context context, @DrawableRes int icon, int selecterIcon, CharSequence title) {
        this(context, null, icon, title);
        this.iconUnSelecter = icon;
        this.iconSelector = selecterIcon;
    }
...
//        mTvTitle.setTextColor(ContextCompat.getColor(context, R.color.tab_unselect));
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            mIcon.setImageResource(iconSelector);
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.select_button));
        } else {
            mIcon.setImageResource(iconUnSelecter);
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.text_black));
        }
    }
